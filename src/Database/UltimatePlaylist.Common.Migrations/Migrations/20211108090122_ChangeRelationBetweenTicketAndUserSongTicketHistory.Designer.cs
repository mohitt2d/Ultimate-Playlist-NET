...
namespace UltimatePlaylist.Database.Migrations.Migrations
{
    ...
    [Migration("20211108090122_ChangeRelationBetweenTicketAndUserSongTicketHistory")]
    partial class ChangeRelationBetweenTicketAndUserSongTicketHistory
    {
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongTicketHistoryEntity", b =>
                {
                    ...
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.Ticket.TicketEntity", "Ticket")
                        .WithOne("UserSongTicketHistory")
                        .HasForeignKey("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongTicketHistoryEntity", "TicketId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
