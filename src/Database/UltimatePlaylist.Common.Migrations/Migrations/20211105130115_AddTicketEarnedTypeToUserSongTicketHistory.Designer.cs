...
namespace UltimatePlaylist.Database.Migrations.Migrations
{
    ...
    [Migration("20211105130115_AddTicketEarnedTypeToUserSongTicketHistory")]
    partial class AddTicketEarnedTypeToUserSongTicketHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Ticket.TicketEntity", b =>
                {
                    ...
                    b.Property<long>("UserSongTicketHistoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UserSongTicketHistoryId")
                        .IsUnique();

                    b.ToTable("Ticket");
                });

            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.BaseUserSongHistoryEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("UserSongHistoryType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasDiscriminator<string>("UserSongHistoryType");
                });
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongRatingHistoryEntity", b =>
                {
                    b.HasBaseType("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.BaseUserSongHistoryEntity");
                    ...
                    b.HasDiscriminator().HasValue("SetRating");
                });

            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongTicketHistoryEntity", b =>
                {
                    b.HasBaseType("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.BaseUserSongHistoryEntity");
                    ...
                    b.HasDiscriminator().HasValue("EarnTicket");
                });
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Ticket.TicketEntity", b =>
                {
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongTicketHistoryEntity", "UserSongTicketHistory")
                        .WithOne("Ticket")
                        .HasForeignKey("UltimatePlaylist.Database.Infrastructure.Entities.Ticket.TicketEntity", "UserSongTicketHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserSongTicketHistory");
                });
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongRatingHistoryEntity", b =>
                {
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.Song.SongEntity", "Song")
                        .WithMany("UserSongRatingHistory")
                        .HasForeignKey("SongId");
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.UserSongHistory.UserSongTicketHistoryEntity", b =>
                {
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.Song.SongEntity", "Song")
                        .WithMany("UserSongTicketHistory")
                        .HasForeignKey("SongId");
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Song.SongEntity", b =>
                {
                    ...
                    b.Navigation("UserSongRatingHistory");
