...
namespace UltimatePlaylist.Database.Migrations.Migrations
{
    ...
    [Migration("20210219163043_UserRolesRemoveSuperfluousColumns")]
    partial class UserRolesRemoveSuperfluousColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Company.CompanyEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Contact.ContactEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Company.CompanyEntity", b =>
                {
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.Identity.User", "Owner")
                        .WithOne("Company")
                        .HasForeignKey("UltimatePlaylist.Database.Infrastructure.Entities.Company.CompanyEntity", "OwnerId")
            ...
            modelBuilder.Entity("UltimatePlaylist.Database.Infrastructure.Entities.Contact.ContactEntity", b =>
                {
                    b.HasOne("UltimatePlaylist.Database.Infrastructure.Entities.Company.CompanyEntity", "Company")
                        .WithOne("Contact")
                        .HasForeignKey("UltimatePlaylist.Database.Infrastructure.Entities.Contact.ContactEntity", "CompanyId");
                });
