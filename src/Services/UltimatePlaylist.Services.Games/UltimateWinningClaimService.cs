...
{
    public class UltimateWinningClaimService : BaseCacheService, IUltimateWinningClaimService
    {
        #region Private Members

        private const string TicketsKey = "ultimateclaim";

        #endregion

        #region Constructor

        public UltimateWinningClaimService(Lazy<IDistributedCache> cacheProvider, IOptions<PlaylistConfig> config)
